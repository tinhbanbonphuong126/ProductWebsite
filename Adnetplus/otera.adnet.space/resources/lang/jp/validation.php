...
return [
    ...
    */
    ...
    'integer'              => ':attributeは小文字で入力してください。',
    ...
    */
    'custom' => [
        ...
        'request_1_time_start' =>[
            'time_cs' => ':attributeは書式と一致していません。'
        ],
        'phone'=>[
            'tel' => ':attributeは書式と一致していません。'
        ]
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    'attributes' => [
        ...
        'venue' => '会場名',
        'venue_address' => '会場住所',
        'times_funeral' => '回葬予想人数',
        'request_1_count_nin' => '名',
        'request_1_time_start' => '時',
        'request_1_time_end' => '時',
        'request_2_count_nin' => '名',
        'request_2_time_start' => '時',
        'request_2_time_end' => '時',
        'request_3_count_nin' => '名',
        'request_3_time_start' => '時',
        'request_3_time_end' => '時',
        'request_4_count_nin' => '名',
        'request_4_time_start' => '時',
        'request_4_time_end' => '時',
        'contact_matter' => '連絡事項',
        'content' => '内容',
        'subject' => '件名',
    ],
