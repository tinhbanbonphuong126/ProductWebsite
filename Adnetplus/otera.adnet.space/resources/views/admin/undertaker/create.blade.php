...
<div class="row">
    ...
    {!! Form::open(['url' => '/admin/undertaker', 'class' => 'form-horizontal', 'files' => true]) !!}
            ...
            <div class="form-group {{ $errors->has('undertaker_name') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-10">
                    {!! Form::text('undertaker_name', null, ['class' => 'form-control','maxlength'=>64]) !!}
            ...
            <div class="form-group {{ $errors->has('other_name') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-10">
                    {!! Form::text('other_name', null, ['class' => 'form-control','maxlength'=>32]) !!}
