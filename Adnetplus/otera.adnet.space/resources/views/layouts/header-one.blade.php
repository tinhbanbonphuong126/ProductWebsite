...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{!! route('under.urequest.create') !!}">@yield('header-title')</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <!-- undertaker -->
                    <li>
                        <a href="{!! route('under.urequest.create') !!}">依頼登録</a>
                    </li>
                    <li>
                        <a href="{!! route('under.ucontact.create') !!}">お問い合わせ</a>
                    </li>
                    <!-- common -->
                    <li>
                        <a href="{!! route('undertaker.logout') !!}">ログアウト</a>
                    </li>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
