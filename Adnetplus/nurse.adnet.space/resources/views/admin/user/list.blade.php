    ...
    <div class="container">
        ...
        <div class="table-border form-border">
            <div class="text-right">
                <a href="{{asset('admin/user/add')}}"><input type="button" class="btn btn-success" value="新規登録"/></a>
            </div>
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tr>
                        <th class="a-arrow">
                            <a href="{{ route('admin.sort.users', ['name' => $name, 'sex' => $sex, 'sort_by' => 'code', 'order_by' => $orderBy == 'asc' ? 'desc' : 'asc']) }}">
                                ID
                        ...
                        <th>性 別</th>
                        <th class="a-arrow">
                            <a href="{{ route('admin.sort.users', ['name' => $name, 'sex' => $sex, 'sort_by' => 'date', 'order_by' => $orderBy == 'asc' ? 'desc' : 'asc']) }}">
                                最終更新日
                                    <div style="display: inline-block;">
                                        <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="pull-right">
                                    <a href="{{ url('admin/user/calendar/' . $row->id) }}"><input type="button" value="詳　細" class="btn-sm btn btn-primary"/></a>
                                    <a href="{{ url('admin/user/edit/' . $row->id) }}"><input type="button" value="編　集" class="btn-sm btn btn-warning"/></a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
        ...
        <div class="pagination-wrapper">{!! $list->appends(['name' => $name, 'sex' => $sex, 'sort_by' => $sortBy, 'order_by' => $orderBy])->render() !!}</div>
        <!--Employee list end-->
    </div>
@endsection
