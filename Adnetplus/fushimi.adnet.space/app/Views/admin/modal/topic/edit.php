    ...
    <div class="modal-dialog modal-lg modal-user">
        <div class="modal-content">
            <div class="modal-body">
                <form class="form-horizontal" method="post" action="<?= url('admin/topic/update') ?>" id="frmEdit" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class='input-group date edit'>
                                <input type='text' class="form-control edit" name="topic_date" required/>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".modal.edit .btn-ok").bind('click', function () {
            ...
            var  newsDate = $(".edit[name=topic_date]").val();
