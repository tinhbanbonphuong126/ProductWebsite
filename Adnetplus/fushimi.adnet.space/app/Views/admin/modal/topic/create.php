    ...
    <div class="modal-dialog modal-sm modal-user">
        <div class="modal-content">
            <div class="modal-body">
                <form class="form-horizontal" method="post" action="<?= url('admin/topic/create') ?>" id="frmCreate" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="control-label col-md-3"><span class="color-red">※</span>タイトル</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class='input-group date'>
                                <input type='text' name="topic_date" class="form-control" />
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".modal.create .btn-ok").bind('click', function () {
            ...
            var  newsDate = $("[name=topic_date]").val();
